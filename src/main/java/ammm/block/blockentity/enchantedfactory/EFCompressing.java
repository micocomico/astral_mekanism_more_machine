...
public class EFCompressing extends BFAdvanced<EFCompressing> {

    public EFCompressing(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
        super(blockProvider, pos, state);
    }

    private int baselineMaxOperations = 1;
    private long gasTankCapacity = 10000;
    ...
    public @NotNull IChemicalTankHolder<Gas, GasStack, IGasTank> getInitialGasTanks(IContentsListener listener) {
        ...
        gasTank = ChemicalTankBuilder.GAS.create(gasTankCapacity * tier.processes, this::containsRecipeB, markAllMonitorsChanged(listener));
        builder.addTank(gasTank);
        return builder.build();
    }

    public EFCompressing getSelf() {
        return this;
    }
    public MachineEnergyContainer<EFCompressing> getEnergyContainer() {
