...
public class EFEnergizedSmelting
    ...
    public EFEnergizedSmelting(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Override
    public MachineEnergyContainer<EFEnergizedSmelting> getEnergyContainer() {
        return energyContainer;
    }

    @Override
    public EFEnergizedSmelting getSelf() {
        return this;
    }
