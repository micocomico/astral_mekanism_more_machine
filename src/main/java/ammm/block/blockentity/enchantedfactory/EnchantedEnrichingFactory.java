...
public class EnchantedEnrichingFactory
        extends MekanismRecipeFactory<ItemStackToItemStackRecipe, EnchantedEnrichingFactory,SingleItem<ItemStackToItemStackRecipe>>
        implements IElectricFactory<EnchantedEnrichingFactory> {
    ...
    public EnchantedEnrichingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Override
    public MachineEnergyContainer<EnchantedEnrichingFactory> getEnergyContainer() {
        return energyContainer;
    }

    @Override
    public EnchantedEnrichingFactory getSelf() {
        return this;
    }
