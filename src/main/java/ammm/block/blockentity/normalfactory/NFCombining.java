...
public class NFCombining extends BFCombining<NFCombining> implements ISustainedData {

    public NFCombining getSelf() {
        return this;
    }
    public MachineEnergyContainer<NFCombining> getEnergyContainer() {
    ...
    public NFCombining(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Override
    protected RecipeCacheLookupMonitor<CombinerRecipe> createRecipeCacheLookupMonitor(int cacheIndex) {
