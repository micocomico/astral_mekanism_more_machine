...
public class NFInfusing extends BFInfusing<NFInfusing> implements ISustainedData {
    ...
    public IChemicalTankHolder<InfuseType, InfusionStack, IInfusionTank> getInitialInfusionTanks(IContentsListener listener) {
        ...
        infusionTank = ChemicalTankBuilder.INFUSION.create(64000000l * tier.processes, this::containsRecipeB, markAllMonitorsChanged(listener));
        builder.addTank(infusionTank);
        return builder.build();
    }

    public NFInfusing getSelf() {
        return this;
    }
    public MachineEnergyContainer<NFInfusing> getEnergyContainer() {
    ...
    public NFInfusing(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Override
    protected RecipeCacheLookupMonitor<MetallurgicInfuserRecipe> createRecipeCacheLookupMonitor(int cacheIndex) {
