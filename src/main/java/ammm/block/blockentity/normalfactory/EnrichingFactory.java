...
public class EnrichingFactory
        extends MekanismProgressFactory<ItemStackToItemStackRecipe, EnrichingFactory, InputRecipeCache.SingleItem<ItemStackToItemStackRecipe>>
        implements IElectricFactory<EnrichingFactory> {
    ...
    public EnrichingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Override
    public MachineEnergyContainer<EnrichingFactory> getEnergyContainer() {
        return energyContainer;
    }

    @Override
    public EnrichingFactory getSelf() {
        return this;
    }
