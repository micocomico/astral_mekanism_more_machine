...
public class NFPurifying extends BFAdvanced<NFPurifying> implements ISustainedData {
    ...
    public NFPurifying getSelf() {
        return this;
    }
    public MachineEnergyContainer<NFPurifying> getEnergyContainer() {
    ...
    public NFPurifying(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
