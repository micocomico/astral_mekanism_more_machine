...
public class NFCrushing
        extends MekanismProgressFactory<ItemStackToItemStackRecipe, NFCrushing, InputRecipeCache.SingleItem<ItemStackToItemStackRecipe>> implements
    ...
    public NFCrushing(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Override
    public MachineEnergyContainer<NFCrushing> getEnergyContainer() {
        return energyContainer;
    }

    @Override
    public NFCrushing getSelf() {
        return this;
    }
