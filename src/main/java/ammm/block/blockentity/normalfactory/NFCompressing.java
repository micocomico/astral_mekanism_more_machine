...
public class NFCompressing extends BFAdvanced<NFCompressing> implements ISustainedData {
    ...
    public @NotNull IChemicalTankHolder<Gas, GasStack, IGasTank> getInitialGasTanks(IContentsListener listener) {
        ...
        gasTank = ChemicalTankBuilder.GAS.create(640000l * tier.processes, this::containsRecipeB, markAllMonitorsChanged(listener));
        builder.addTank(gasTank);
        return builder.build();
    }

    public NFCompressing getSelf() {
        return this;
    }
    public MachineEnergyContainer<NFCompressing> getEnergyContainer() {
    ...
    public NFCompressing(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
