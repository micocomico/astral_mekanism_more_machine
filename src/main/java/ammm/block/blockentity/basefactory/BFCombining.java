...
public abstract class BFCombining<BE extends MekanismRecipeFactory<CombinerRecipe, BE, InputRecipeCache.DoubleItem<CombinerRecipe>>>
        extends MekanismRecipeFactory<CombinerRecipe, BE, InputRecipeCache.DoubleItem<CombinerRecipe>>
    ...
    public final IInputHandler<@NotNull ItemStack> extraInputHandler;
    ...
    public BFCombining(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    protected InventorySlotHelper addSlots(InventorySlotHelper builder, IContentsListener listener,
        ...
        builder.addSlot(extraSlot = InputInventorySlot.at(this::containsRecipeB, markAllMonitorsChanged(listener), 7, 62));
