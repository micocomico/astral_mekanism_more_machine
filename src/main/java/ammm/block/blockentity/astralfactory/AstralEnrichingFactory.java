...
public class AstralEnrichingFactory
        extends MekanismRecipeFactory<ItemStackToItemStackRecipe, AstralEnrichingFactory,SingleItem<ItemStackToItemStackRecipe>>
        implements IElectricFactory<AstralEnrichingFactory> {
    ...
    public AstralEnrichingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Override
    public MachineEnergyContainer<AstralEnrichingFactory> getEnergyContainer() {
        return energyContainer;
    }

    @Override
    public AstralEnrichingFactory getSelf() {
        return this;
    }
