...
public class AFPurifying extends BFAdvanced<AFPurifying> {

    public AFPurifying(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    public AFPurifying getSelf() {
        return this;
    }
    public MachineEnergyContainer<AFPurifying> getEnergyContainer() {
