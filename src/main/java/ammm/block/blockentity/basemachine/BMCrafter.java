package ammm.block.blockentity.basemachine;
...
public class BMCrafter extends TileEntityRecipeMachine<AstralCraftingRecipe>
    ...
    private MachineEnergyContainer<BMCrafter> energyContainer;
    ...
    public BMCrafter(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    public MachineEnergyContainer<BMCrafter> getEnergyContainer() {
