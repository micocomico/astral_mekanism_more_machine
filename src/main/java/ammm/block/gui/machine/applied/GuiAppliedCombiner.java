...
public class GuiAppliedCombiner extends GuiAppliedDoubleToSingleEnergizedMachine<AppliedCombiner> {

    public GuiAppliedCombiner(MekanismTileContainer<AppliedCombiner> container, Inventory inv, Component title) {
        super(container, inv, title);
    }

    @Override
    protected MekanismJEIRecipeType<?>[] getJEIJeiRecipeTypes() {
        return new MekanismJEIRecipeType[] { MekanismJEIRecipeType.COMBINING };
    }
