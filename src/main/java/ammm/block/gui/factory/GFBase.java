...
public class GFBase<BE extends TileEntityConfigurableMachine & IAMMMFactory<BE>>
        extends GuiConfigurableTile<BE, CFBase<BE>> {

    protected int page;
    protected final int maxPage;
    protected final List<IPagedGuiElement> pagedElements;

    public GFBase(CFBase<BE> container, Inventory inv, Component title) {
