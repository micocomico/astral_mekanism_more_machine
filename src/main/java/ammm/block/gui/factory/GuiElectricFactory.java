...
public class GuiElectricFactory<BE extends MekanismRecipeFactory<ItemStackToItemStackRecipe, BE, InputRecipeCache.SingleItem<ItemStackToItemStackRecipe>> & IElectricFactory<BE>>
        extends GuiAstralMekanismFactory<BE> {

    public GuiElectricFactory(ContainerAstralMekanismFactory<BE> container, Inventory inv, Component title) {
